var Main = function () {
    ...
    this.infoArray = [];
    this.postCount = 0;
    this.accessToken = ''; //Here will be your Facebook Access_Token
        ...
        success: function (content) {
            ...
            $.each(content.data, function (i, item) {
                ...
                if(item.created_time){
                	...
                	var m  = moment(opost.time,'RRRR-MM-DD HH:mm:ss');
                    opost.time = m.format('MMMM Do YYYY, h:mm a')
                    //opost.time = opost.time.toISOString();
                   }
